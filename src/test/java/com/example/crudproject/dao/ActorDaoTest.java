...
class ActorDaoTest {
    ...
    void setUp() {
        testActor = new Actor();
        testActor.setId(1L);
        testActor.setName("John");
        testActor.setSurname("Doe");
        testActor.setRole("Hero");
    ...
    void actorRowMapperTest() throws SQLException {
        ...
        when(resultSet.getString("role")).thenReturn("Hero");
        ...
        assertEquals("John", mappedActor.getName());
        assertEquals("Doe", mappedActor.getSurname());
        assertEquals("Hero", mappedActor.getRole());
